 ...
 */
final class Version20260918092647 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO app_user (id, email, roles, password, numero_passeport, nom, prenom, date_naissance, lieu_naissance, nationalite, sexe, date_emission, date_expiration, pays_emission, telephone, adresse, ville, pays, code_postal, profession, situation_familiale, created_at, updated_at) SELECT id, email, roles, password, numero_passeport, nom, prenom, date_naissance, lieu_naissance, nationalite, sexe, date_emission, date_expiration, pays_emission, telephone, adresse, ville, pays, code_postal, profession, situation_familiale, created_at, updated_at FROM __temp__app_user');
